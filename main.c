...
{
	all->texture_NO.img = mlx_xpm_file_to_image(all->win.mlx, "../textures/redbrick.xpm", &all->texture_NO.width, &all->texture_NO.height);
	...
	all->texture_SO.img = mlx_xpm_file_to_image(all->win.mlx, "../textures/wood.xpm", &all->texture_SO.width, &all->texture_SO.height);
	...
	all->texture_WE.img = mlx_xpm_file_to_image(all->win.mlx, "../textures/mossy.xpm", &all->texture_WE.width, &all->texture_WE.height);
	...
	all->texture_EA.img = mlx_xpm_file_to_image(all->win.mlx, "../textures/greystone.xpm", &all->texture_EA.width, &all->texture_EA.height);
